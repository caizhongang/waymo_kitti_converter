...
load_dir = '/home/alex/github/waymo_to_kitti_converter/tools/dataloader/kitti'
...
def boxes3d_to_corners3d_lidar(x, y, z, l, w, h, ry):
    """
...
def main():
    ...
    for i in range(bboxes.shape[0]):
        x, y, z, l, w, h, ry, t = bboxes[i].tolist()
        bbox_corners = boxes3d_to_corners3d_lidar(x, y, z, l, w, h, ry)
    ...
    pc_range_box = get_range_box(0, -39.68, -3, 69.12, 39.68, 1)
    pc_range_box_lines = corners_to_lines(pc_range_box.T.tolist(), color=[1,0,0])

    test_range_box = get_range_box(0, -40, -3.0, 70.4, 40, 3.0)
